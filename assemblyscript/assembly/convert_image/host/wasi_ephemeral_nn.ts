...
export declare function convert_image(path_ptr: i32, path_len: i32, width: i32, height: i32, precision: i32, out_buffer: i32, out_buffer_len: i32, out_bytes_written: i32): i32;